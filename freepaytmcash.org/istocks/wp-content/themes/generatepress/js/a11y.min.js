/(trident|msie)/i.test(navigator.userAgent) && document.getElementById && window.addEventListener && window.addEventListener("hashchange", function() {
    ...
    function() {
        ...
        if ("querySelector" in document && "addEventListener" in window && document.body.classList.contains("dropdown-hover"))
            for (var e = document.querySelectorAll("nav ul a"), n = document.querySelectorAll(".sf-menu .menu-item-has-children"), t = function() {
                ...
                }, o = 0; o < e.length; o++) e[o].addEventListener("focus", t), e[o].addEventListener("blur", t);
        if ("touchend" in document.documentElement)
            for (o = 0; o < n.length; o++) n[o].addEventListener("touchend", function(e) {
                if (!n[o].closest("nav").classList.contains("toggled") && 1 === e.touches.length && (e.stopPropagation(), !this.classList.contains("sfHover"))) {
                    e.target !== this && e.target.parentNode !== this || e.preventDefault();
                    var t = n[o].closest("nav").querySelectorAll("ul.toggled-on");
